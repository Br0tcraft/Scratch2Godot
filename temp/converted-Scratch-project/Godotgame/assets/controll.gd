...
#
#  Game License Notes:
#    - You are free to share and remix games using this script.
#    - Attribution must be provided if source code is shared.
#    - If distributing the source, it must include credit to the
#      original author.
#
#  Copyright (c) 2024 Br0tcraft
# ============================================================
